...
import { Search, Filter, Mic, Sparkles, Calendar, User, Clock, Tag } from 'lucide-react'
import type { LibraryViewProps, Note } from '../types'
import { cn } from '@/lib/utils'

export function LibraryView({ notes, onSearch, onFilterChange, onSelectNote }: LibraryViewProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Minha Biblioteca</h1>
